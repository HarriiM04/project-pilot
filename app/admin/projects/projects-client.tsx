...
import {
  ...
  Clock, X, ChevronUp, ChevronDown, Globe, Check, Sparkles, Loader2,
} from 'lucide-react'
import { cn, parseAgencyDetails } from '@/lib/utils'
    ...
    <div className="p-4 lg:p-8 max-w-7xl mx-auto w-full space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-xl border border-border bg-card hover:bg-muted text-foreground px-4 py-2.5 text-xs font-semibold cursor-pointer transition-all active:scale-[0.98]"
        >
